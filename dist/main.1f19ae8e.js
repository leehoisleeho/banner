...
var imgArr = ["url(./img/1.jpg)", "url(./img/2.jpg)", "url(./img/3.jpg)", "url(./img/4.jpg)", "url(./img/5.jpg)"]; //获取class为“tab1”的元素
...
var banner = document.getElementById("banner_1"); // 下面圈的样式，点那个就加上样式，并且清除其他圈的样式
